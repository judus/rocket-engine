 ...
 * a noise sequence generator producing a more naturally ordered, harmonic
 * succession of numbers compared to the standard <a href="#/p5/noise">noise()</a> function.
 * It was invented by Ken Perlin in the 1980s and been used since in
 * graphical applications to produce procedural textures, natural motion,
 * shapes, terrains etc.<br /><br /> The main difference to the
 * <a href="#/p5/noise">noise()</a> function is that Perlin noise is defined in an infinite
 * n-dimensional space where each pair of coordinates corresponds to a
 * fixed semi-noise value (fixed only for the lifespan of the program; see
...
export default class P5noise {
	 ...
	 * the same pseudo-noise numbers each time the software is run.
	 *
	 * @method noiseSeed
	...
	noiseSeed(seed) {
		...
		const lcg = (() => {
			...
			return {
				setSeed(val) {
					// pick a noise seed if val is undefined or null
